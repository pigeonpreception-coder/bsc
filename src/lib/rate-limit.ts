...
// pattern as ai_generation.
export const checkMfaChallengeRateLimit = (userId: string, ip: string | null) =>
  checkRateLimit("mfa_challenge", userId, ip);
export const recordMfaChallengeAttempt = (userId: string, ip: string | null, success: boolean) =>
  recordAttempt("mfa_challenge", userId, ip, success);
